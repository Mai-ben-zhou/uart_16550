...
vsim -t ns -voptargs=+acc work.uart_top_tb
...
#添加波形区分说明
add wave -divider {uart_top_tb} 
#添加波形
add wave uart_top_tb/*
#添加波形区分说明
add wave -divider {rx_fifo} 
#添加波形
add wave rx_fifo/*
#添加波形区分说明
add wave -divider {tx_fifo} 
#添加波形
add wave tx_fifo/*
#添加波形区分说明
add wave -divider {uart_rx_init} 
#添加波形
add wave uart_rx_init/*
#添加波形区分说明
add wave -divider {uart_tx_init} 
#添加波形
add wave uart_tx_init/*
###常用添加波形指令
#-radix red -----设置波形颜色
